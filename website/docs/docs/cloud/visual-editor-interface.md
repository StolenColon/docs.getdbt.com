...
description: "The Canvas interface contains an operator toolbar, operators, and a canvas to help you access and transform data through a seamless drag-and-drop dbt model creation experience in dbt Cloud." 
...
- **Input**: Select the model and columns you want to use.
...
- **Output**: The final transformed dataset generated by a <Constant name="dbt" /> model.
