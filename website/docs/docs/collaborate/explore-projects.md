...
- **Auto-exposures** &mdash; [Set up](/docs/cloud-integrations/auto-exposures#set-up-auto-exposures) and [view auto-exposures](/docs/collaborate/auto-exposures) to automatically expose relevant data models from Tableau or Power BI to enhance visibility.
