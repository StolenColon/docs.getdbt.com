...
To add sources, staging and business entities to your project, refer to [Staging: Preparing our atomic building blocks](/best-practices/how-we-structure/2-staging) for our best practices on project stages.
