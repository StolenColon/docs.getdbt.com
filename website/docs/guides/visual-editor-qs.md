...
<Lightbox src="/img/docs/dbt-cloud/visual-editor/ve-screen.png" width="90%" title="The number of items in Canvas is defined in this section." />
...
<Lightbox src="/img/docs/dbt-cloud/visual-editor/operators.png" width="90%" title="The operator’s menu on the side of Canvas." />
...
<Lightbox src="/img/docs/dbt-cloud/visual-editor/ve-model-folder.png" width="90%" title="Example of model path in GitHub." />
