...
|[Source freshness known limitation](/reference/resource-configs/snowflake-configs#source-freshness-known-limitation)|Snowflake determines source freshness using the `LAST_ALTERED` column.|
