...
1. After setting up auto-exposures in dbt Cloud, you can view them in [dbt Explorer](/docs/collaborate/explore-projects) for a richer experience.
2. Navigate to dbt Explorer by clicking on the **Explore** link in the navigation.
3. From the **Overview** page, you can view auto-exposures from a couple of places:
   - [Exposures menu](#exposures-menu)
   - [File tree](#file-tree)
   - [Project lineage](#project-lineage) <br /><br />
